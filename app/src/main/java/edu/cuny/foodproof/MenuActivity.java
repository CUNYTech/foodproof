...
public class MenuActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sharedPreferences = this.getSharedPreferences("MyPref", MODE_APPEND);

    }
    public void onClick(View view) {
        try {
            new makePostRequest().execute("http://ec2-54-90-187-63.compute-1.amazonaws.com/ingredient/add");
        }
        catch(Exception e){
